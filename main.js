...
// var test = findSmallestPurchase(allpurchases)
var sumOfSmallestPurchase = findSmallestPurchase(allpurchases).reduce(function(accu,value){
  return accu += value.price
},
0
);
//
